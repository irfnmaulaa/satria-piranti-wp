...
add_action('init', function () {
    ...
    register_taxonomy('product-option', 'product', [
        'label' => 'Options',
        'hierarchical' => true,
    ]);

    // register post type
    register_post_type('car-rental', [
        'labels' => [
            'name' => 'Car Rental',
            'singular_name' => 'Car Rental',
            'add_new' => 'Add New Car Rental',
            'add_new_item' => 'Add New Car Rental',
            'new_item' => 'New Car Rental',
            'view_item' => 'View Car Rental',
            'view_items' => 'View Car Rental',
            'all_items' => 'All Car Rental',
        ],
        'public' => true,
        'supports' => ['title',],
        'menu_position' => 20,
        ...
        'show_in_graphql' => true,
        'show_in_nav_menus' => true,
        'graphql_single_name' => 'Car Rental',
        'graphql_plural_name' => 'Car Rentals',
    ]);

    register_taxonomy('car-brand', 'car-rental', [
        'label' => 'Car Brand',
        'hierarchical' => true,
    ]);

    register_taxonomy('car-category', 'car-rental', [
        'label' => 'Categories',
        'hierarchical' => true,
    ]);
...
function get_meta_defaults()
{
    return [
        ...
        'image' => get_template_directory_uri() . '/img/image.webp'
    ];
}
