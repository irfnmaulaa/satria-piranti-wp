...
<section class="bg-white border-b border-slate-200">
  <div class="container mx-auto py-24">
    <div class="flex justify-between items-center mb-10">
      <div>
        <h2 class="text-4xl font-semibold font-plus-jakarta-sans leading-10 text-black">
          <?php echo esc_html($title); ?>
        </h2>
      </div>
      <div class="flex gap-6">
        <button class="p-4 rounded-xl border border-slate-200 flex items-center testimonial-prev">
        ...
        <button class="p-4 rounded-xl border border-slate-200 flex items-center testimonial-next">
          <span class="w-4 h-4">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6 12L10 8L6 4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            ...
            <div class="rounded-[20px] border border-white flex flex-col gap-6">
              <div class="flex items-start gap-6">
                ...
                <div class="flex flex-col gap-0.5">
                  <h3 class="text-xl font-medium font-inter leading-7 text-black">
                    <?php echo esc_html($item['user']['full_name']); ?>
                  </h3>
                  <p class="text-base font-normal font-inter text-black">
                    <?php echo esc_html($item['user']['company']); ?>
                  </p>
                </div>
              </div>
              <p class="text-lg font-normal font-inter leading-7 text-black">
