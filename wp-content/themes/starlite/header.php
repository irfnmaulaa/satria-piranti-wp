...
<header id="header" class="navbar w-full h-[80px] lg:h-[120px] fixed top-0 left-0 bg-white z-[20]">
    <div class="container h-full flex items-center justify-between">
        ...
        <label for="mobile-menus-checkbox" class="w-[18px] h-[18px] inline-flex lg:hidden flex-col gap-1.5 relative">
            <span class="w-full h-[2px] bg-[#0A0B09] absolute left-0 top-0"></span>
            <span class="w-full h-[2px] bg-[#0A0B09] absolute left-0 top-[50%] translate-y-[-50%]"></span>
            <span class="w-full h-[2px] bg-[#0A0B09] absolute left-0 top-[100%] translate-y-[-100%]"></span>
        </label>

        <a href="<?php echo get_front_page_url(); ?>" class="logo-wrapper">
            <img src="<?php echo get_logo(); ?>" alt="logo" class="logo h-[40px]">
        </a>
    </div>
</header>
